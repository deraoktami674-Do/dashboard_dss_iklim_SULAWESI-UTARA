...
st.set_page_config(page_title="DSS Iklim Sumsel", layout="wide")

st.title("🌦️ Decision Support System Iklim - SULAWESI UTARA")
...
if uploaded_file:
    ...
    data = process_data("SULAWESI UTARA.xlsx")
